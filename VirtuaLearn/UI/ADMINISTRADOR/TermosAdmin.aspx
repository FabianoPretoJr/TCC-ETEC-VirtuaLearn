<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TermosAdmin.aspx.cs" Inherits="VirtuaLearn.UI.TermosAdmin" %>
                            ...
                            <div class="col-lg-12 col-md-12">
                                <div class="card ">
                                    <div class="card-header">
                                        <h4 class="card-title">Cadastrar Termos de Uso</h4>
                                    </div>
                                    <div class="card-body">
                                        <div class="table-responsive">
                                            <table class="table tablesorter " id="">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <asp:Button ID="btnCadastrar" class="btn btn-fill btn-primary" runat="server" Text="Cadastrar" OnClick="btnCadastrar_Click"></asp:Button>
                                                        </td>
                                                    </tr>
