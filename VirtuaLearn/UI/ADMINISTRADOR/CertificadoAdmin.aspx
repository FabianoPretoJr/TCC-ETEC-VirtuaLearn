<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CertificadoAdmin.aspx.cs" Inherits="VirtuaLearn.UI.ADMINISTRADOR.CertificadoAdmin" %>
                    ...
                    <div class="content">
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12">
                                <div class="card ">
                                    <div class="card-header">
                                        <h4 class="card-title">Upar Certificado</h4>
                                    </div>
                                    <div class="card-body">
                                        <div class="table-responsive">
                                            <table class="table tablesorter " id="">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <label>Upar certificado:</label>
                                                            <br/>
                                                            <br/>
                                                            <asp:FileUpload ID="fulTermos" runat="server" AllowMultiple="true" />
                                                            <asp:Label ID="lblMensagem" runat="server" Text=""></asp:Label>
                                                        </td>
                                                    </tr>                                                  
                                                    <tr>
                                                        <td>
                                                            <asp:Button ID="btnCadastrar" class="btn btn-fill btn-primary" runat="server" Text="Cadastrar"></asp:Button>
                                                        </td>
                                                    </tr>
                            ...
                            <!--<div class="col-lg-6 col-md-12">
                                <div class="card ">
                                    <div class="card-header">
                                        <h4 class="card-title">Atualizar Termos de Uso</h4>
                                    </div>
                                    <div class="card-body">
                                        <div class="table-responsive">
                                            <table class="table tablesorter " id="">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <label>Digite os Termos de Uso:</label>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <asp:Button ID="btnAtualizar" class="btn btn-fill btn-primary" runat="server" Text="Atualizar"></asp:Button>
                                                        </td>
                                                    </tr>
