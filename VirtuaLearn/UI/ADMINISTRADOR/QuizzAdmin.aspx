<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QuizzAdmin.aspx.cs" Inherits="VirtuaLearn.UI.QuizzAdmin" %>
                            ...
                            <div class="col-lg-12 col-md-12">
                                <div class="card ">
                                    <div class="card-header">
                                        <h4 class="card-title">
                                            <asp:Label ID="lblCad" runat="server" Text="Criar Quizz"></asp:Label>
                                            <asp:Label ID="lblAtu" runat="server" Text="Atualizar Quizz" Visible="False"></asp:Label>
                                        </h4>
                                    </div>
                                    <div class="card-body">
                                            ...
                                            <table class="table tablesorter " id="">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <label>Nome:</label>
                                                            <asp:TextBox ID="txtNome" class="form-control" Width="250" runat="server"></asp:TextBox>

                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                            <asp:DropDownList ID="ddlCurso" class="form-control" Width="250" runat="server" Visible="True"></asp:DropDownList>
                                                            <asp:Label ID="lblIdC" runat="server" Text="" Visible="False"></asp:Label>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                            <asp:Button ID="btnEnviar" runat="server" class="btn btn-fill btn-primary" Text="Enviar" OnClick="btnEnviar_Click" Visible="True" />
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12">
                                <div class="card ">
                                    <div class="card-header">
                                        <h4 class="card-title">
                                            <asp:Label ID="Label1" runat="server" Text="Listar Quizz"></asp:Label>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            ...
                                                            <asp:GridView ID="gvQuizz" runat="server"  OnRowCommand="gvQuizz_RowCommand">
                                                                <Columns>
                                                                    <asp:TemplateField ShowHeader="False">
                                                                        <ItemTemplate>
                                                                            <asp:Button ID="btnExluir" runat="server" CausesValidation="false" class="btn btn-fill btn-danger" CommandName="cmdExcluir" Text="Excluir" CommandArgument='<%#Eval("Id_Quizz")%>' OnClientClick="return confirm('Deseja realmente excluir?')" />
                                                                        </ItemTemplate>
                                                                    </asp:TemplateField>
                                                                    <asp:TemplateField ShowHeader="False">
                                                                        <ItemTemplate>
                                                                            <asp:Button ID="btnAdicionar" runat="server" CausesValidation="false" CommandName="cmdAdicionar" Text="Adicionar Pergunta" class="btn btn-fill btn-sucess"  CommandArgument='<%#Eval("Id_Quizz")%>' />
                                                                        </ItemTemplate>
                                                                    </asp:TemplateField>
                                                                    <asp:TemplateField ShowHeader="False">
                                                                        <ItemTemplate>
                                                                            <asp:Button ID="btnAtualizar" runat="server" CausesValidation="false" CommandName="cmdAtualizar" Text="Atualizar" class="btn btn-fill btn-sucess" CommandArgument='<%#Eval("Id_Quizz")%>' />
                                                                        </ItemTemplate>
                                                                    </asp:TemplateField>
                                                                </Columns>
                                                            </asp:GridView>
