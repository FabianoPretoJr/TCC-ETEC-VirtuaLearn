<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ConteudosAdmC.aspx.cs" Inherits="VirtuaLearn.UI.PagAdmComun.ConteudosAdmC" %>
                    ...
                    <div class="content">
                        ...
                        <div class="row">
                                            ...
                                            <table class="table tablesorter " id="">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <label>Video: </label>
                                                            <asp:TextBox ID="txtVideo" class="form-control" runat="server" MaxLength="30"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                            ...
                            <div class="col-lg-6 col-md-12">
                                <!--<div class="card ">
                                    <div class="card-header">
                                        <h4 class="card-title">Atualizar Conteudo</h4>
                                    </div>
                                    <div class="card-body">
                                        <div class="table-responsive">
                                            <table class="table tablesorter " id="">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                            <asp:Label ID="lblId3" runat="server" Text=""></asp:Label>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <label>Nome:</label>
                                                            <br />
                                                            <asp:TextBox ID="txtNome1" class="form-control" runat="server" MaxLength="20"></asp:TextBox><br />
                                                            <br />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                            <label>Video: </label>
                                                            <asp:TextBox ID="txtVideo1" class="form-control" runat="server" MaxLength="30"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                            <label>Material:</label>
                                                            <br />
                                                            <asp:FileUpload ID="fulMaterial1" runat="server" Enabled="False" /><br />
                                                            <br />
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <label>Descrição: </label>
                                                            <asp:TextBox ID="txtDescricao1" class="form-control" runat="server" MaxLength="100"></asp:TextBox>
                                                            <br />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                            ...
                                                            <asp:Label ID="lblMensagem1" runat="server" Text=""></asp:Label><br />
