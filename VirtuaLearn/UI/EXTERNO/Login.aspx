<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="VirtuaLearn.UI.login" %>
                    ...
                    <div class="container h-100">
                        <div class="d-flex justify-content-center h-100">
                            <div class="user_card">
                                ...
                                <div class="d-flex justify-content-center form_container">
                                    <div>
                                        <div class="input-group mb-3">
                                            ...
                                            <asp:TextBox ID="txtEmail" class="form-control input_user" runat="server" placeholder="Usuário" MaxLength="30"></asp:TextBox>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <div class="custom-control custom-checkbox">
                                                <asp:CheckBox ID="CheckBox" runat="server" class="custom-control-input"/>                                         
                                                <!--label class="custom-control-label" for="customControlInline">Mantenha-me conectado.</!--label-->
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <!--h5>Ou:</!--h5>
                                <div class="d-flex justify-content-center mt-3 login_container">
                                    <button type="button" name="button" class="btn gmail_btn">Entrar com Gmail</button>
                                </div>
                                <div class="d-flex justify-content-center mt-3 login_container">
                                    <button type="button" name="button" class="btn face_btn">Entrar com Facebook</button>
                                </div-->
                                <div class="mt-4">
                                    <div class="d-flex justify-content-center links">
                                        <asp:LinkButton ID="btnCadastro" runat="server" class="ml-2" OnClick="btnCadastro_Click">Cadastre-se</asp:LinkButton>
                                    </div>
                                    <div class="d-flex justify-content-center links">
                                        <asp:LinkButton ID="btnEsqueceu" class="ml-2" runat="server" OnClick="btnEsqueceu_Click">Esqueceu sua senha?</asp:LinkButton>
                                    </div>
                                </div>
