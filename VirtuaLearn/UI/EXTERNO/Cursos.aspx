<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Cursos.aspx.cs" Inherits="VirtuaLearn.UI.Cursos" %>
                ...
                <div class="container">
                    <div class="card">
                        <div class="face face1">
                            <div class="content">
                                <img src="img/open-book.png" />
                                <h3>Tecnologias para o ensino de línguas</h3>
                                <h5>
                                    <br />
                                    R$ 60,00</h5>
                            </div>
                    ...
                    <div class="card">
                        <div class="face face1">
                            <div class="content">
                                <img src="img/hand.png" />
                                <h3>Custeio, precificação e apuração de resultados</h3>
                                <h5>
                                    <br />
                                    R$ 60,00</h5>
                            </div>
                    ...
                    <div class="card">
                        <div class="face face1">
                            <div class="content">
                                <img src="img/libra.png" />
                                <h3>Introdução às Bases Moleculares da Oncogênese</h3>
                                <h5>
                                    <br />
                                    R$ 300,00</h5>
                            </div>
                ...
                <div class="container">
                    <div class="card">
                        <div class="face face1">
                            <div class="content">
                                <img src="img/open-book.png" />
                                <h3>Bolsa de Valores para Iniciantes 1</h3>
                                <h5>
                                    <br />
                                    R$ 60,00</h5>
                            </div>
                    ...
                    <div class="card">
                        <div class="face face1">
                            <div class="content">
                                <img src="img/hand.png" />
                                <h3>Bolsa de Valores para Iniciantes 2</h3>
                                <h5>
                                    <br />
                                    R$ 60,00</h5>
                            </div>
                ...
                <div class="container">
                    <div class="card">
                        <div class="face face1">
                            <div class="content">
                                <img src="img/open-book.png" />
                                <h3>Introdução à Astrobiologia </h3>
                                <h5>
                                    <br />
                                    R$ 300,00</h5>
                            </div>
                ...
                <div class="container">
                    ...
                    <div class="card">
                        <div class="face face1">
                            <div class="content">
                                <img src="img/hand.png" />
                                <h3>Introdução à Física Nuclear</h3>
                                <h5>
                                    <br />
                                    R$ 300,00</h5>
                            </div>
                ...
                <div class="container mt-3">
                    <div class="row">
                        <div class="owl-carousel owl-theme">
                            <div class="item">
                                <div class="card">
                                    <img src="cart_img/trova.jpg" alt="img" class="card-img-top" />
                                    <div class="card-body">
                                        <h3>curso 1</h3>
                                        <h5>$<span class="text-center">23</span></h5>
                                        <p>lorem ipsun olha o texto aqui kkj</p>
                            ...
                            <div class="item">
                                <div class="card">
                                    <img src="" alt="img" class="card-img-top" />
                                    <div class="card-body">
                                        <h3>curso 1</h3>
                                        <h5>$<span class="text-center">23</span></h5>
                                        <p>lorem ipsun olha o texto aqui kkj</p>
