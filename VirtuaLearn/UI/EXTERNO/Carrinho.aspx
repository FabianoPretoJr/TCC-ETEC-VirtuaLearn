<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Carrinho.aspx.cs" Inherits="VirtuaLearn.UI.Carinho" %>
...
<head runat="server">
    ...
    <link href="../css/CarinhoList.css" rel="stylesheet" />
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table product-table">
                                ...
                                <h2><img src="../img/compra.png" height="80" width="80"/><br/>Minhas compras<h2/>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <th scope="row">
                                            <img src="../cart_img/bolsa.jpg"  width="150" height="150" class="rounded-circle"  alt="" class="img-fluid z-depth-0"/>
                                        </th>
                                        <td>
                                            <p class="mt-3">
                                    ...
                                    <tr>
                                        <th scope="row">
                                            <img src="../cart_img/negociacoes.jpg"    width="150" height="150" class="rounded-circle" alt="" class="img-fluid z-depth-0"/>
                                        </th>
                                        <td>
                                            <p class="mt-3">
                                                <strong>Tecnicas de negociação</strong>
                                            </p>
                                    ...
                                    <tr>
                                        <th scope="row">
                                            <img  src="../cart_img/trovadorismo.jpg"   width="150" height="150" class="rounded-circle" alt="" class="img-fluid z-depth-0"/>
                                        </th>
                                        <td>
                                            <p class="mt-3">
                                                <strong>Trovadorismo</strong>
                                            </p>
